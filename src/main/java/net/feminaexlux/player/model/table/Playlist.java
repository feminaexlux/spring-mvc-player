...
public class Playlist extends TableImpl<PlaylistRecord> {
	...
	private static final long serialVersionUID = 2036672360;
	...
	/**
	 * The column <code>media.playlist.user</code>.
	 */
	public final TableField<PlaylistRecord, String> USER = createField("user", SQLDataType.VARCHAR.length(255).nullable(false), this, "");
	...
	public UniqueKey<PlaylistRecord> getPrimaryKey() {
		return Key.KEY_PLAYLIST_PRIMARY;
	}
	...
	public List<UniqueKey<PlaylistRecord>> getKeys() {
		return Arrays.<UniqueKey<PlaylistRecord>>asList(Key.KEY_PLAYLIST_PRIMARY);
	}
	...
	public List<ForeignKey<PlaylistRecord, ?>> getReferences() {
		return Arrays.<ForeignKey<PlaylistRecord, ?>>asList(Key.FK1_PLAYLIST_PRINCIPAL);
	}
